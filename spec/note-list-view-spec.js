...
function testoHTML() {
  ...
  assert.isTrue(noteListView.toHtml() == "<ul><li><div id='6'>Note message</div></li></ul>")
};
...
function testoMultipleHTML() {
  ...
  var noteListView = new NoteListView(noteList);
  assert.isTrue(noteListView.toHtml() === "<ul><li><div id='7'>Note message</div></li><li><div id='8'>Please fucking work!</div></li></ul>")
}
